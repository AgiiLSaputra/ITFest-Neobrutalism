      ...
      <ScrollReveal animation="animate-pop-up" delay={0.5}>
        <div className="flex justify-center mt-10">
          <a
            ...
            className="inline-flex items-center gap-2 bg-neo-green text-black font-black uppercase tracking-wider px-8 py-4 neo-border neo-shadow text-sm sm:text-base transition-all hover:translate-x-1 hover:-translate-y-1 hover:shadow-none active:translate-x-2 active:-translate-y-2 active:shadow-none"
          >
