      ...
      <div className="container mx-auto px-6 max-w-screen-xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <a
              className="flex items-center gap-4 mb-6 bg-white dark:bg-[#16213e] p-4 neo-border dark:border-white inline-flex transition-colors"
              href="#"
            >
              <img
            ...
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  className="w-12 h-12 bg-white neo-border neo-shadow-sm flex items-center justify-center hover:bg-neo-yellow hover:shadow-none hover:-translate-y-1 transition-all group"
                  aria-label={s.label}
          ...
          {/* Links */}
          <div>
            <h4 className="text-black font-black mb-6 uppercase text-xl tracking-wider bg-neo-green inline-block px-2 neo-border">
              Navigasi
            </h4>
            <ul className="space-y-4">
              <li>
                <a
                  className="font-bold hover:bg-black hover:text-white px-2 py-1 transition-colors text-lg inline-block border-2 border-transparent hover:border-black"
                  href="#beranda"
                >
                  Beranda
                </a>
          ...
          {/* Info */}
          <div>
            <h4 className="text-black font-black mb-6 uppercase text-xl tracking-wider bg-neo-blue inline-block px-2 neo-border">
              Kontak
            </h4>
            <ul className="space-y-2 text-lg font-bold">
              <li className="bg-white dark:bg-[#16213e] px-2 py-1 neo-border dark:border-white border-2 transition-colors">
              ...
              <li className="pt-4">
                <a
                  className="bg-black text-white px-4 py-2 neo-border hover:bg-neo-yellow hover:text-black transition-colors block text-center"
        ...
        <div className="border-t-4 border-black pt-8 flex flex-col md:flex-row items-center justify-between gap-4 font-bold">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="bg-white dark:bg-[#16213e] px-3 py-1 neo-border dark:border-white font-black text-xs uppercase tracking-widest transition-colors">
              Made with ❤ by IF'26
            </span>
          </div>
        </div>
