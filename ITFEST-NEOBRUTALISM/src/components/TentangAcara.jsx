        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2 flex flex-col gap-8">
            <ScrollReveal animation="animate-neo-slam" delay={0.2}>
              <div className="p-8 bg-white neo-border neo-shadow flex gap-6 items-start hover:bg-neo-blue transition-colors group cursor-default neo-tilt">
                <div className="flex-shrink-0 w-16 h-16 bg-white neo-border flex items-center justify-center relative z-10 group-hover:animate-neo-swing">
            ...
            <ScrollReveal animation="animate-neo-slam" delay={0.35}>
              <div className="p-8 bg-white neo-border neo-shadow flex gap-6 items-start hover:bg-neo-pink transition-colors group cursor-default neo-tilt">
                <div className="flex-shrink-0 w-16 h-16 bg-white neo-border flex items-center justify-center group-hover:animate-neo-swing">
            ...
            <ScrollReveal animation="animate-neo-slam" delay={0.5}>
              <div className="p-8 bg-white neo-border neo-shadow flex gap-6 items-start hover:bg-neo-green transition-colors group cursor-default neo-tilt">
                <div className="flex-shrink-0 w-16 h-16 bg-white neo-border flex items-center justify-center group-hover:animate-neo-swing">
